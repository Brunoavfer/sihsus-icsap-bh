...
- ✅ **Scripts 24–26 corrigidos (P16–P25, jun/2026)** — análises de sensibilidade auditadas e corrigidas:
  ...
  - **Script 25 (P17/P21)**: dois desfechos — (1) contagem absoluta log-linear [idêntico script 11], (2) proporção no total ICSAP (GLS linear, p.p./ano); diabetes abs p<0,001 mas **prop p=0,571 NS** → redução proporcional ao total, não efeito clínico seletivo; cardiovascular e respiratório NS em volume abs mas sig em proporção (+2,32 e +0,30 pp/ano, p=0,006 e 0,035) → outros grupos caíram mais rápido causando aumento relativo de CV e resp.; nova saída: `its_por_grupo_prop.csv`
  - **Script 26**: Tabela S4 com 2 painéis (absoluta + proporcional) e notas de moderação; Tabela S5 com densidade real, T1 destacado em vermelho (sig inesperado → confirma mecanismo); P25: n_leitos ausente em variaveis_cs.csv
